    ...
    <section className="w-full bg-[#F8FAFC] py-6 sm:py-8">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6">
          ...
          <ScrollReveal className="lg:col-span-8 flex flex-col" animation="fade-up" duration={750} distance={24}>
            <div className="bg-gradient-to-br from-slate-100 via-white to-slate-50 rounded-3xl border border-slate-200/80 p-6 sm:p-10 md:p-12 relative overflow-hidden shadow-xs flex flex-col justify-between min-h-[380px] sm:min-h-[440px] h-full">
              ...
              <div className="relative z-10 max-w-md space-y-4">
                ...
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-slate-200 text-[#FF5A36] text-xs font-black uppercase tracking-wider shadow-2xs">
                  ...
                  <span>Smart Kitchen Innovation</span>
                </div>
                ...
                <p className="text-slate-600 text-xs sm:text-sm sm:leading-relaxed font-normal">
                  Effortless one-touch mincing in under 10 seconds. High-torque cordless design with 304 food-grade stainless steel blades for onions, garlic, herbs, and baby food. Special launch offer: <strong>₹899</strong> <span className="line-through text-slate-400">₹1,499</span>.
                </p>
              ...
              {/* Featured Product Visual: Mini Chopper */}
              <div className="absolute right-0 bottom-0 w-1/2 sm:w-5/12 h-full hidden sm:flex items-end justify-end pointer-events-none pr-4 pb-2">
                <img
                  ...
                  alt="Wireless Electric Mini Food Chopper & Garlic Mincer"
                  className="w-full max-h-[360px] object-contain object-bottom rounded-2xl drop-shadow-2xl transition-transform duration-500 hover:scale-105"
                />
              </div>
            </div>
          </ScrollReveal>
          ...
          <StaggerContainer className="lg:col-span-4 flex flex-col gap-4 sm:gap-5" staggerDelay={120} baseDelay={80} animation="fade-left">
            ...
            {/* Card 2: Festive Kitchen Prep Card */}
            <div className="flex-1 bg-slate-900 text-white rounded-3xl p-5 sm:p-6 flex items-center justify-between shadow-xs relative overflow-hidden">
              ...
              <div className="space-y-1.5 max-w-[65%] relative z-10">
                <span className="text-[10px] font-black uppercase tracking-wider text-orange-400 bg-white/10 px-2 py-0.5 rounded-full inline-block">
                  Festival Kitchen Prep
                </span>
                <h3 className="text-base sm:text-lg font-black text-white leading-snug">
                  ₹899 Launch Discount
                </h3>
                <p className="text-[11px] sm:text-xs text-slate-300">
                  Flat 40% OFF original ₹1,499 compare price.
                </p>
                <button
                  onClick={() => {
        ...
        <ScrollReveal animation="fade-up" delay={120} duration={650}>
          <div className="bg-white rounded-2xl border border-slate-200/80 p-4 sm:p-6 shadow-2xs">
            <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 divide-y sm:divide-y-0 sm:divide-x divide-slate-100" staggerDelay={70}>
